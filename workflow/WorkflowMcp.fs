...
let private tools =
    """[{"name":"task_create","description":"Create a Workflow task using the strict schema-v1 DTO boundary.","inputSchema":{"type":"object","additionalProperties":false,"required":["projectRoot","taskId","title","kind","acceptanceCriteria","workItems"],"properties":{"projectRoot":{"type":"string","minLength":1},"taskId":{"type":"string","minLength":1},"title":{"type":"string","minLength":1},"kind":{"type":"string","enum":["execution","research"]},"profile":{"type":"string","minLength":1},"acceptanceCriteria":{"type":"array","items":{"type":"object","additionalProperties":false,"required":["id","text"],"properties":{"id":{"type":"string","minLength":1},"text":{"type":"string","minLength":1}}}},"workItems":{"type":"array","items":{"$ref":"#/$defs/workItem"}}},"$defs":{"workItem":{"type":"object","additionalProperties":false,"required":["id","title","children"],"properties":{"id":{"type":"string","minLength":1},"title":{"type":"string","minLength":1},"dependsOn":{"type":"array","items":{"type":"string","minLength":1}},"children":{"type":"array","items":{"$ref":"#/$defs/workItem"}}}}}}},{"name":"task_get","description":"Read a Workflow task without changing state.","inputSchema":{"type":"object","additionalProperties":false,"required":["projectRoot","taskId"],"properties":{"projectRoot":{"type":"string","minLength":1},"taskId":{"type":"string","minLength":1}}}},{"name":"task_apply","description":"Apply one Workflow command with expectedStateRevision CAS.","inputSchema":{"type":"object","additionalProperties":false,"required":["projectRoot","taskId","expectedStateRevision","command"],"properties":{"projectRoot":{"type":"string","minLength":1},"taskId":{"type":"string","minLength":1},"expectedStateRevision":{"type":"integer","minimum":0},"command":{"oneOf":[{"type":"object","additionalProperties":false,"required":["type","workItemId"],"properties":{"type":{"type":"string","const":"start"},"workItemId":{"type":"string","minLength":1}}},{"type":"object","additionalProperties":false,"required":["type","workItemId","result"],"properties":{"type":{"type":"string","const":"complete-work"},"workItemId":{"type":"string","minLength":1},"result":{"type":"string","minLength":1},"evidenceRefs":{"type":"array","items":{"type":"string","minLength":1}}}},{"type":"object","additionalProperties":false,"required":["type","workItemId","resumeCondition"],"properties":{"type":{"type":"string","const":"wait"},"workItemId":{"type":"string","minLength":1},"resumeCondition":{"type":"string","minLength":1}}},{"type":"object","additionalProperties":false,"required":["type","workItemId","blocker"],"properties":{"type":{"type":"string","const":"block"},"workItemId":{"type":"string","minLength":1},"blocker":{"type":"string","minLength":1}}},{"type":"object","additionalProperties":false,"required":["type","workItemId"],"properties":{"type":{"type":"string","const":"resume"},"workItemId":{"type":"string","minLength":1},"observationRef":{"type":"string","minLength":1}}},{"type":"object","additionalProperties":false,"required":["type","workItemId","role","reason"],"properties":{"type":{"type":"string","const":"rebind-owner"},"workItemId":{"type":"string","minLength":1},"role":{"type":"string","minLength":1},"agentId":{"type":"string","minLength":1},"reason":{"type":"string","minLength":1}}},{"type":"object","additionalProperties":false,"required":["type","id","kind","source","summary"],"properties":{"type":{"type":"string","const":"add-evidence"},"id":{"type":"string","minLength":1},"kind":{"type":"string","minLength":1},"source":{"type":"string","minLength":1},"summary":{"type":"string","minLength":1},"subject":{"type":"string","minLength":1},"producerRole":{"type":"string","minLength":1},"producerId":{"type":"string","minLength":1},"reference":{"type":"string","minLength":1}}},{"type":"object","additionalProperties":false,"required":["type","evidenceId","reason"],"properties":{"type":{"type":"string","const":"supersede-evidence"},"evidenceId":{"type":"string","minLength":1},"reason":{"type":"string","minLength":1}}},{"type":"object","additionalProperties":false,"required":["type","acceptanceId","evidenceRefs"],"properties":{"type":{"type":"string","const":"verify"},"acceptanceId":{"type":"string","minLength":1},"evidenceRefs":{"type":"array","items":{"type":"string","minLength":1}}}},{"type":"object","additionalProperties":false,"required":["type","id","target","checkpoint","kind"],"properties":{"type":{"type":"string","const":"add-guard"},"id":{"type":"string","minLength":1},"target":{"type":"string","minLength":1},"checkpoint":{"type":"string","enum":["beforeStart","beforeComplete"]},"kind":{"type":"string","minLength":1},"minimumCount":{"type":"integer","minimum":1,"default":1},"producerRole":{"type":"string","minLength":1},"independent":{"type":"boolean","default":false},"applicability":{"type":"string","minLength":1},"waiver":{"type":"string","minLength":1}}},{"type":"object","additionalProperties":false,"required":["type","guardId"],"properties":{"type":{"type":"string","const":"mark-not-applicable"},"guardId":{"type":"string","minLength":1},"decisionRef":{"type":"string","minLength":1}}},{"type":"object","additionalProperties":false,"required":["type","guardId"],"properties":{"type":{"type":"string","const":"waive-guard"},"guardId":{"type":"string","minLength":1},"decisionRef":{"type":"string","minLength":1}}},{"type":"object","additionalProperties":false,"required":["type","kind","targets","rationale"],"properties":{"type":{"type":"string","const":"add-decision"},"kind":{"type":"string","enum":["userDecision","designDecision","assumption","policyApplication","contractRevision","applicabilityDecision","waiverDecision"]},"targets":{"type":"array","items":{"type":"string","minLength":1}},"rationale":{"type":"string","minLength":1}}},{"type":"object","additionalProperties":false,"required":["type","id","text","impact"],"properties":{"type":{"type":"string","const":"add-question"},"id":{"type":"string","minLength":1},"text":{"type":"string","minLength":1},"impact":{"type":"string","minLength":1}}},{"type":"object","additionalProperties":false,"required":["type","questionId","decisionRef"],"properties":{"type":{"type":"string","const":"resolve-question"},"questionId":{"type":"string","minLength":1},"decisionRef":{"type":"string","minLength":1}}},{"type":"object","additionalProperties":false,"required":["type","reason","targets"],"properties":{"type":{"type":"string","const":"reopen"},"reason":{"type":"string","minLength":1},"targets":{"type":"array","items":{"type":"string","minLength":1}},"decisionRef":{"type":"string","minLength":1}}},{"type":"object","additionalProperties":false,"required":["type","patch"],"properties":{"type":{"type":"string","const":"apply-contract-patch"},"patch":{"oneOf":[{"type":"object","additionalProperties":false,"required":["type","id","text"],"properties":{"type":{"type":"string","const":"addAcceptanceCriterion"},"id":{"type":"string","minLength":1},"text":{"type":"string","minLength":1}}},{"type":"object","additionalProperties":false,"required":["type","id","text"],"properties":{"type":{"type":"string","const":"updateAcceptanceCriterion"},"id":{"type":"string","minLength":1},"text":{"type":"string","minLength":1}}},{"type":"object","additionalProperties":false,"required":["type","id"],"properties":{"type":{"type":"string","const":"removeAcceptanceCriterion"},"id":{"type":"string","minLength":1}}},{"type":"object","additionalProperties":false,"required":["type","id","target","checkpoint","kind"],"properties":{"type":{"type":"string","const":"addGuard"},"id":{"type":"string","minLength":1},"target":{"type":"string","minLength":1},"checkpoint":{"type":"string","enum":["beforeStart","beforeComplete"]},"kind":{"type":"string","minLength":1},"minimumCount":{"type":"integer","minimum":1,"default":1},"producerRole":{"type":"string","minLength":1},"independent":{"type":"boolean","default":false},"applicability":{"type":"string","minLength":1},"waiver":{"type":"string","minLength":1}}},{"type":"object","additionalProperties":false,"required":["type","id"],"properties":{"type":{"type":"string","const":"removeGuard"},"id":{"type":"string","minLength":1}}},{"type":"object","additionalProperties":false,"required":["type","text"],"properties":{"type":{"type":"string","const":"setObjective"},"text":{"type":"string","minLength":1}}},{"type":"object","additionalProperties":false,"required":["type","text"],"properties":{"type":{"type":"string","const":"setScope"},"text":{"type":"string","minLength":1}}},{"type":"object","additionalProperties":false,"required":["type","text"],"properties":{"type":{"type":"string","const":"setNonGoals"},"text":{"type":"string","minLength":1}}}]},"decisionRef":{"type":"string","minLength":1}}},{"type":"object","additionalProperties":false,"required":["type","plan"],"properties":{"type":{"type":"string","const":"reconcile-contract-drift"},"plan":{"oneOf":[{"type":"object","additionalProperties":false,"required":["type"],"properties":{"type":{"type":"string","const":"acceptExternalContract"}}},{"type":"object","additionalProperties":false,"required":["type","objective","scope","nonGoals","acceptanceCriteria"],"properties":{"type":{"type":"string","const":"restoreCanonicalContract"},"objective":{"type":"string","minLength":1},"scope":{"type":"string","minLength":1},"nonGoals":{"type":"string","minLength":1},"acceptanceCriteria":{"type":"array","items":{"type":"object","additionalProperties":false,"required":["id","text"],"properties":{"id":{"type":"string","minLength":1},"text":{"type":"string","minLength":1}}}}}}]}}},{"type":"object","additionalProperties":false,"required":["type","reason"],"properties":{"type":{"type":"string","const":"reclassify-task"},"kind":{"type":"string","enum":["execution","research"]},"profile":{"type":"string","minLength":1},"reason":{"type":"string","minLength":1}}},{"type":"object","additionalProperties":false,"required":["type"],"properties":{"type":{"type":"string","const":"reconcile-profile-drift"}}},{"type":"object","additionalProperties":false,"required":["type","state","evidenceSummary","next"],"properties":{"type":{"type":"string","const":"complete-task"},"state":{"type":"string","minLength":1},"evidenceSummary":{"type":"string","minLength":1},"next":{"type":"string","minLength":1}}}]}}}},{"name":"task_validate","description":"Validate a persisted Workflow task and report contract/profile drift.","inputSchema":{"type":"object","additionalProperties":false,"required":["projectRoot","taskId"],"properties":{"projectRoot":{"type":"string","minLength":1},"taskId":{"type":"string","minLength":1}}}}]"""
