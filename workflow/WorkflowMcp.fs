...
let private failure error =
    ...
    // W4/AC19: authority denials additionally carry the structured remediation
    // block rendered by Workflow.renderAuthorityMetadata; every non-authority
    // error envelope stays byte-identical.
    match tryAuthorityMetadata error with
    | Some metadata -> detail["authority"] <- renderAuthorityMetadata metadata
    | None -> ()
...
// W3/AC17: tool schemas are published from this single inline literal, kept
// parallel to parseOperation/parseCommand up in this module. The wire grammar
// (prefix-encoded targets and id patterns) is not a direct System.Text.Json
// shape, so it is authored here rather than generated from the DTOs; the
// executable contract is tests/SchemaParityGuardTests.fsx, which enforces
// recursive required/properties parity, variant coverage, and enum round-trip
// against the public parser functions.
let private tools =
    """[{"name":"task_create","description":"Create a Workflow task using the strict schema-v1 DTO boundary.","inputSchema":{"type":"object","additionalProperties":false,"required":["projectRoot","taskId","title","kind","acceptanceCriteria","workItems"],"properties":{"projectRoot":{"type":"string","minLength":1},"taskId":{"type":"string","pattern":"^[A-Za-z]+-[0-9]+$"},"title":{"type":"string","minLength":1},"kind":{"type":"string","enum":["execution","research"]},"profile":{"type":"string","minLength":1},"acceptanceCriteria":{"type":"array","minItems":1,"items":{"type":"object","additionalProperties":false,"required":["id","text"],"properties":{"id":{"type":"string","pattern":"^AC[0-9]+$"},"text":{"type":"string","minLength":1}}}},"workItems":{"type":"array","minItems":1,"items":{"type":"object","additionalProperties":false,"required":["id","title","children"],"properties":{"id":{"type":"string","pattern":"^W[0-9]+(\\.[0-9]+)*$"},"title":{"type":"string","minLength":1},"dependsOn":{"type":"array","items":{"type":"string","pattern":"^W[0-9]+(\\.[0-9]+)*$"}},"children":{"type":"array","items":{"$ref":"#/$defs/workItem"}}}}}},"$defs":{"workItem":{"type":"object","additionalProperties":false,"required":["id","title","children"],"properties":{"id":{"type":"string","pattern":"^W[0-9]+(\\.[0-9]+)*$"},"title":{"type":"string","minLength":1},"dependsOn":{"type":"array","items":{"type":"string","pattern":"^W[0-9]+(\\.[0-9]+)*$"}},"children":{"type":"array","items":{"$ref":"#/$defs/workItem"}}}}}}},{"name":"task_get","description":"Read a Workflow task without changing state.","inputSchema":{"type":"object","additionalProperties":false,"required":["projectRoot","taskId"],"properties":{"projectRoot":{"type":"string","minLength":1},"taskId":{"type":"string","pattern":"^[A-Za-z]+-[0-9]+$"}}}},{"name":"task_apply","description":"Apply one Workflow command with expectedStateRevision CAS. Operations requiring User authority fail closed with structured remediation data (requiredAuthority, decisionKind, target, decisionRefStatus) under the `error.authority` block. Ordinary Coordinator invocation cannot manufacture User authority.","inputSchema":{"type":"object","additionalProperties":false,"required":["projectRoot","taskId","expectedStateRevision","command"],"properties":{"projectRoot":{"type":"string","minLength":1},"taskId":{"type":"string","pattern":"^[A-Za-z]+-[0-9]+$"},"expectedStateRevision":{"type":"integer","minimum":0},"command":{"oneOf":[{"type":"object","additionalProperties":false,"required":["type","workItemId"],"properties":{"type":{"const":"start"},"workItemId":{"type":"string"}}},{"type":"object","additionalProperties":false,"required":["type","workItemId","result"],"properties":{"type":{"const":"complete-work"},"workItemId":{"type":"string"},"result":{"type":"string","minLength":1},"evidenceRefs":{"type":"array","items":{"type":"string"}}}},{"type":"object","additionalProperties":false,"required":["type","workItemId","resumeCondition"],"properties":{"type":{"const":"wait"},"workItemId":{"type":"string"},"resumeCondition":{"type":"string","minLength":1}}},{"type":"object","additionalProperties":false,"required":["type","workItemId","blocker"],"properties":{"type":{"const":"block"},"workItemId":{"type":"string"},"blocker":{"type":"string","minLength":1}}},{"type":"object","additionalProperties":false,"required":["type","workItemId"],"properties":{"type":{"const":"resume"},"workItemId":{"type":"string"},"observationRef":{"type":"string"}}},{"type":"object","additionalProperties":false,"required":["type","workItemId","role","reason"],"properties":{"type":{"const":"rebind-owner"},"workItemId":{"type":"string"},"role":{"type":"string","minLength":1},"agentId":{"type":"string"},"reason":{"type":"string","minLength":1}}},{"type":"object","additionalProperties":false,"required":["type","id","kind","source","summary"],"properties":{"type":{"const":"add-evidence"},"id":{"type":"string","pattern":"^E[0-9]+$"},"kind":{"oneOf":[{"type":"string","enum":["build","test","review","observation","externalEffect","research","decisionEvidence"]},{"type":"string","pattern":"^other:.*\\S.*$"}]},"source":{"type":"string","minLength":1},"summary":{"type":"string","minLength":1},"subject":{"type":"string"},"producerRole":{"type":"string"},"producerId":{"type":"string"},"reference":{"type":"string"}}},{"type":"object","additionalProperties":false,"required":["type","evidenceId","reason"],"properties":{"type":{"const":"supersede-evidence"},"evidenceId":{"type":"string","pattern":"^E[0-9]+$"},"reason":{"type":"string","minLength":1}}},{"type":"object","additionalProperties":false,"required":["type","acceptanceId","evidenceRefs"],"properties":{"type":{"const":"verify"},"acceptanceId":{"type":"string","pattern":"^AC[0-9]+$"},"evidenceRefs":{"type":"array","minItems":1,"items":{"type":"string","minLength":1}}}},{"type":"object","additionalProperties":false,"required":["type","id","target","checkpoint","kind"],"properties":{"type":{"const":"add-guard"},"id":{"type":"string","pattern":"^G[0-9]+$"},"target":{"oneOf":[{"const":"task"},{"type":"string","pattern":"^workItem:W[0-9]+(\\.[0-9]+)*$"}]},"checkpoint":{"type":"string","enum":["beforeStart","beforeComplete"]},"kind":{"oneOf":[{"type":"string","enum":["build","test","review","observation","externalEffect","research","decisionEvidence"]},{"type":"string","pattern":"^other:.*\\S.*$"}]},"minimumCount":{"type":"integer","minimum":1},"producerRole":{"type":"string"},"independent":{"type":"boolean"},"applicability":{"oneOf":[{"const":"always"},{"type":"string","pattern":"^explicitDecision:(coordinator|user)$"}]},"waiver":{"oneOf":[{"const":"notWaivable"},{"type":"string","pattern":"^waivableBy:(coordinator|user)$"}]}}},{"type":"object","additionalProperties":false,"required":["type","guardId"],"properties":{"type":{"const":"mark-not-applicable"},"guardId":{"type":"string","pattern":"^G[0-9]+$"},"decisionRef":{"type":"string","pattern":"^D[0-9]+$"}}},{"type":"object","additionalProperties":false,"required":["type","guardId"],"properties":{"type":{"const":"waive-guard"},"guardId":{"type":"string","pattern":"^G[0-9]+$"},"decisionRef":{"type":"string","pattern":"^D[0-9]+$"}}},{"type":"object","additionalProperties":false,"required":["type","kind","targets","rationale"],"properties":{"type":{"const":"add-decision"},"kind":{"type":"string","enum":["userDecision","designDecision","assumption","policyApplication","contractRevision","applicabilityDecision","waiverDecision"]},"targets":{"type":"array","minItems":1,"items":{"oneOf":[{"type":"string","pattern":"^waiveAcceptance:AC[0-9]+$"},{"type":"string","pattern":"^guardDisposition:G[0-9]+$"},{"type":"string","pattern":"^skipWorkItem:W[0-9]+(\\.[0-9]+)*$"},{"type":"string","pattern":"^requirementChange:W[0-9]+(\\.[0-9]+)*$"},{"type":"string","pattern":"^contractPatch:.+$"},{"type":"string","pattern":"^reopenTask:[A-Za-z]+-[0-9]+[|](acceptance:AC[0-9]+|workItem:W[0-9]+(\\.[0-9]+)*|guard:G[0-9]+)(;(acceptance:AC[0-9]+|workItem:W[0-9]+(\\.[0-9]+)*|guard:G[0-9]+))*$"},{"type":"string","pattern":"^questionResolution:Q[0-9]+$"},{"type":"string","pattern":"^reclassify:.+$"},{"type":"string","pattern":"^other:.+$"}]}},"rationale":{"type":"string","minLength":1}}},{"type":"object","additionalProperties":false,"required":["type","id","text","impact"],"properties":{"type":{"const":"add-question"},"id":{"type":"string","pattern":"^Q[0-9]+$"},"text":{"type":"string","minLength":1},"impact":{"oneOf":[{"const":"taskWide"},{"type":"string","pattern":"^workItems:W[0-9]+(\\.[0-9]+)*(,W[0-9]+(\\.[0-9]+)*)*$"}]}}},{"type":"object","additionalProperties":false,"required":["type","questionId","decisionRef"],"properties":{"type":{"const":"resolve-question"},"questionId":{"type":"string","pattern":"^Q[0-9]+$"},"decisionRef":{"type":"string","pattern":"^D[0-9]+$"}}},{"type":"object","additionalProperties":false,"required":["type","reason","targets"],"properties":{"type":{"const":"reopen"},"reason":{"type":"string","minLength":1},"targets":{"type":"array","minItems":1,"items":{"oneOf":[{"type":"string","pattern":"^acceptance:AC[0-9]+$"},{"type":"string","pattern":"^workItem:W[0-9]+(\\.[0-9]+)*$"},{"type":"string","pattern":"^guard:G[0-9]+$"}]}},"decisionRef":{"type":"string","pattern":"^D[0-9]+$"}}},{"type":"object","additionalProperties":false,"required":["type","patch"],"properties":{"type":{"const":"apply-contract-patch"},"patch":{"oneOf":[{"type":"object","additionalProperties":false,"required":["type","id","text"],"properties":{"type":{"const":"addAcceptanceCriterion"},"id":{"type":"string","pattern":"^AC[0-9]+$"},"text":{"type":"string","minLength":1}}},{"type":"object","additionalProperties":false,"required":["type","id","text"],"properties":{"type":{"const":"updateAcceptanceCriterion"},"id":{"type":"string","pattern":"^AC[0-9]+$"},"text":{"type":"string","minLength":1}}},{"type":"object","additionalProperties":false,"required":["type","id","target","checkpoint","kind"],"properties":{"type":{"const":"addGuard"},"id":{"type":"string","pattern":"^G[0-9]+$"},"target":{"oneOf":[{"const":"task"},{"type":"string","pattern":"^workItem:W[0-9]+(\\.[0-9]+)*$"}]},"checkpoint":{"type":"string","enum":["beforeStart","beforeComplete"]},"kind":{"oneOf":[{"type":"string","enum":["build","test","review","observation","externalEffect","research","decisionEvidence"]},{"type":"string","pattern":"^other:.*\\S.*$"}]},"minimumCount":{"type":"integer","minimum":1},"producerRole":{"type":"string"},"independent":{"type":"boolean"},"applicability":{"oneOf":[{"const":"always"},{"type":"string","pattern":"^explicitDecision:(coordinator|user)$"}]},"waiver":{"oneOf":[{"const":"notWaivable"},{"type":"string","pattern":"^waivableBy:(coordinator|user)$"}]}}},{"type":"object","additionalProperties":false,"required":["type","id"],"properties":{"type":{"const":"removeGuard"},"id":{"type":"string","pattern":"^G[0-9]+$"}}},{"type":"object","additionalProperties":false,"required":["type","id"],"properties":{"type":{"const":"removeAcceptanceCriterion"},"id":{"type":"string","pattern":"^AC[0-9]+$"}}},{"type":"object","additionalProperties":false,"required":["type","text"],"properties":{"type":{"const":"setObjective"},"text":{"type":"string","minLength":1}}},{"type":"object","additionalProperties":false,"required":["type","text"],"properties":{"type":{"const":"setScope"},"text":{"type":"string","minLength":1}}},{"type":"object","additionalProperties":false,"required":["type","text"],"properties":{"type":{"const":"setNonGoals"},"text":{"type":"string","minLength":1}}}]},"decisionRef":{"type":"string","pattern":"^D[0-9]+$"}}},{"type":"object","additionalProperties":false,"required":["type","plan"],"properties":{"type":{"const":"reconcile-contract-drift"},"plan":{"oneOf":[{"type":"object","additionalProperties":false,"required":["type"],"properties":{"type":{"const":"acceptExternalContract"}}},{"type":"object","additionalProperties":false,"required":["type","objective","scope","nonGoals","acceptanceCriteria"],"properties":{"type":{"const":"restoreCanonicalContract"},"objective":{"type":"string"},"scope":{"type":"string"},"nonGoals":{"type":"string"},"acceptanceCriteria":{"type":"array","items":{"type":"object","additionalProperties":false,"required":["id","text"],"properties":{"id":{"type":"string","pattern":"^AC[0-9]+$"},"text":{"type":"string","minLength":1}}}}}}]}}},{"type":"object","additionalProperties":false,"required":["type","reason"],"properties":{"type":{"const":"reclassify-task"},"kind":{"type":"string","enum":["execution","research"]},"profile":{"type":"string","minLength":1},"reason":{"type":"string","minLength":1}}},{"type":"object","additionalProperties":false,"required":["type"],"properties":{"type":{"const":"reconcile-profile-drift"}}},{"type":"object","additionalProperties":false,"required":["type","state","evidenceSummary","next"],"properties":{"type":{"const":"complete-task"},"state":{"type":"string","minLength":1},"evidenceSummary":{"type":"string","minLength":1},"next":{"type":"string","minLength":1}}}]}}}},{"name":"task_validate","description":"Validate a persisted Workflow task and report contract/profile drift.","inputSchema":{"type":"object","additionalProperties":false,"required":["projectRoot","taskId"],"properties":{"projectRoot":{"type":"string","minLength":1},"taskId":{"type":"string","pattern":"^[A-Za-z]+-[0-9]+$"}}}}]"""
